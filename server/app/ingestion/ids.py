...
def chunk_id(model: str, chunk: Chunk) -> str:
    """Hash of the embedding model, source, position, kind and text of a chunk."""
    parts = [model, chunk.source, str(chunk.index), str(chunk.is_image_caption), chunk.text]
