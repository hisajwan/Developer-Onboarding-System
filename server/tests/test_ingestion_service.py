...
from tests.helpers import InMemoryDocumentStore, InMemoryRegistry, InMemoryVectorStore
...
class World:
    ...
    def __init__(self, embedder: FakeEmbedder | None = None, **overrides) -> None:
        ...
        self.settings = {"max_upload_bytes": 1_000_000, **SMALL, **overrides}
        self.service = self.build(self.embedder)

    def build(self, embedder: FakeEmbedder, **overrides) -> IngestionService:
